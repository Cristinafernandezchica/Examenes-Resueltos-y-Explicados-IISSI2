  ...
  const renderProduct = ({ item }) => {
    return (
      ...
      >
        ...
        {/* SOLUTION */}
        <TextSemiBold textStyle={styles.price}>Nutrientes</TextSemiBold>
        <TextSemiBold textStyle={styles.price}>   Grasas: {item.grasas}</TextSemiBold>
        <TextSemiBold textStyle={styles.price}>   Proteínas: {item.proteinas}</TextSemiBold>
        <TextSemiBold textStyle={styles.price}>   Carbohidratos: {item.carbohidratos}</TextSemiBold>
        <TextSemiBold textStyle={styles.price}>   Calorías: {item.calorias}</TextSemiBold>
        {!item.availability &&
          <TextRegular textStyle={styles.availability }>Not available</TextRegular>
        }
         <View style={styles.actionButtonsContainer}>
         <View style={{ flex: 1 }} /> {/* Para echar los botones hacia la derecha y poder ver el texto */}
          <Pressable
