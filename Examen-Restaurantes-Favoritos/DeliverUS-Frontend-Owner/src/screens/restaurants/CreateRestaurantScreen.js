...
export default function CreateRestaurantScreen ({ navigation }) {
  ...
  // solition (favorito: false)
  const initialRestaurantValues = { name: null, description: null, address: null, postalCode: null, url: null, shippingCosts: null, email: null, phone: null, restaurantCategoryId: null, favorito: false }
        ...
        <ScrollView>
          <View style={{ alignItems: 'center' }}>
            <View style={{ width: '60%' }}>
              ...
              {/* solution: añadimos el switch para decidir si al crear el restaurante es favorito o no */}
              <TextRegular>Mark as favorite? </TextRegular>
              <Switch
                trackColor={{ false: GlobalStyles.brandSecondary, true: GlobalStyles.brandPrimary }}
                thumbColor={values.favorito ? GlobalStyles.brandSecondary : '#f4f3f4'}
                value={values.favorito}
                style={styles.switch}
                onValueChange={value =>
                  setFieldValue('favorito', value)
                }
              />
