...
// solution: añadimos el calculo de las calorias al crear un producto
const create = async function (req, res) {
  req.body.calorias = (req.body.grasas * 9) + (req.body.proteinas * 4) + (req.body.carbohidratos * 4) //
...
// solution: añadimos para calcular las calorias del producto
const update = async function (req, res) {
  try {
    ...
    /*
    const product = await Product.findByPk(req.params.productId)
    const newCalorias = (product.grasas * 9) + (product.proteinas * 4) + (product.carbohidratos * 4)
