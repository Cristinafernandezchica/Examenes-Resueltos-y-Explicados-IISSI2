...
export default function CreateRestaurantScreen ({ navigation, route }) { // solution: añadimos route para obtener la nueva categoría creada
  ...
  }, [route]) // solution: añadimos route pra que aparezca la nueva categoría creada sin actualizar
        ...
        <ScrollView>
          <View style={{ alignItems: 'center' }}>
            <View style={{ width: '60%' }}>
              ...
              {/* solution: botón para acceder a la pantalla de creación de categorías */}
              <Pressable
