// solution: calse creada específicamente para la solución
...
export default function CreateRestaurantCategoryScreen ({ navigation }) {
  ...
  const createRestaurantCategory = async (category) => {
    setBackendErrors([])
    try {
      await createCategory(category)
      showMessage({
        message: `Restaurant Category ${category.name} succesfully created`,
        type: 'success',
