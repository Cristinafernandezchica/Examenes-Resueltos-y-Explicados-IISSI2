...
// solution: añadimos import del modal de confirmación
...
export default function RestaurantsScreen ({ navigation, route }) {
  ...
  const renderRestaurant = ({ item }) => {
    return (
      ...
      >
        ...
        {/* solution: añadimos el view para poder ver el shipping cost y el texto en promoción en la misma línea */}
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          <TextSemiBold>Shipping: <TextSemiBold textStyle={{ color: GlobalStyles.brandPrimary }}>{item.shippingCosts.toFixed(2)}€</TextSemiBold></TextSemiBold>
          {/* solution: texto ¡En promoción! */}
          {item.promoted &&
        ...
        {/* solution: botón prar promocionar desde la pantalla de restaurantes */}
          <Pressable
  ...
  // solution: lógica para promocionar un restaurante
  ...
  return (
    ...
    {/* solution: modal de confirmación para realizar la promoción */}
    <ConfirmationModal
...
const styles = StyleSheet.create({
  ...
  // solution: para el texto ¡En promoción!
  badge: {
    textAlign: 'center',
    borderWidth: 2,
