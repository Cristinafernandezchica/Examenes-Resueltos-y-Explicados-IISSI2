...
// solution: añadimos el import de updateStatus
...
export default function RestaurantsScreen ({ navigation, route }) {
  ...
  const renderRestaurant = ({ item }) => {
    return (
      ...
      >
        ...
        {/* solution: texto que nos indica si el restaurante está online/offline/closed/temporarily closed */}
        ...
        {/* solution: añadimos el botón para cambiar de estado */}
  ...
  // solution: método que maneja la lógica para cambiar el estado del restaurante
  const updateRestaurantStatus = async (restaurant) => {
    try {
      await updateStatus(restaurant.id)
      await fetchRestaurants()
      showMessage({
        message: `Restaurant ${restaurant.name} now is ${restaurant.status} `,
        type: 'success',
        style: GlobalStyles.flashStyle,
        titleStyle: GlobalStyles.flashTextStyle
      })
      ...
      console.log(error)
      showMessage({
        message: `The status of the restaurant ${restaurant.name} cannot be changed.`,
        type: 'error',
        style: GlobalStyles.flashStyle,
        titleStyle: GlobalStyles.flashTextStyle
      })
